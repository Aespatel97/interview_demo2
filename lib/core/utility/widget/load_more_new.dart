...
class LoadMoreListViewNew extends StatefulWidget {
  const LoadMoreListViewNew(
  ...
  @override
  LoadMoreListViewNewState createState() {
    return LoadMoreListViewNewState();
  }
}

class LoadMoreListViewNewState extends State<LoadMoreListViewNew> {
  LoadMoreListViewNewState() {
    _loadingMoreStream =
          ...
          return Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                if (widget.loadMore != null && _loadingMore)
                  const Padding(
